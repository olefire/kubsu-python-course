...
школьников сперва записано количество языков, которое он знает, а
затем – названия языков, по одному в строке.
...
таких
языков.
Затем – количество языков, которые знает хотя бы один школьник, на
следующих строках – список таких языков. Языки нужно выводить в
